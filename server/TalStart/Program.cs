...
builder.Services.AddTransient<IDatasetService>(x => new DatasetService(x.GetRequiredService<IParser>(),x.GetRequiredService<IQueryBuilder>(),x.GetRequiredService<ISqlService>(),x.GetRequiredService<IFileService>()));
