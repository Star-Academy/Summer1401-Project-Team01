...
export class CreatePipelineComponent {
  ...
  public constructor(private pipelineService: PipelineService, private snackbar: SnackbarService, public dialogRef: MatDialogRef<CreatePipelineComponent>, @Inject(MAT_DIALOG_DATA) data: any, private pipelineValueService: PipelineValueService) {
  }
